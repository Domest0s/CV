...
\address{Heiglhofstr. 66/512}{81377, Munchen}
...
\cvitem{}{Have been made the restore work and reverse engineering for Si-strip sensor-based detector equipment (ASIC + FPGA based DAQ) and further developing of the prototype.}{}{}{}{}
%----------------------------------------------------------------------------------------
...
\cventry{July 2011 - Sept 2011}{Intern at ``DESY Summer Student Programme''}{Zeuthen}{Germany}{}{
\begin{itemize}
...
\cvitem{Programming languages}{
	\texttt{\textbf{C/C++}} (advanced) \newline 
	\LaTeX , ActionScript 3.0, ROOT, Mathematica, MATLAB (good) \newline{}
	Objective-C, Verilog, FORTRAN, SQL, Python, Pascal (basic)}
\cvitem{Additional skills}{Git, CMake, bash, LabVIEW, PhotoShop}
\cvitem{target programming}{TIZEN OS mobile, Arduino, FPGA(Altera, Xilinx), STM32, ATmega8}
